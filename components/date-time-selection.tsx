...
export function DateTimeSelection({
  ...
  const fetchAvailableDates = async () => {
    try {
      setLoading(true)
      // Mock available dates - في التطبيق الحقيقي، يتم جلبها من API
      const dates: string[] = []
  ...
  const fetchTimeSlots = async (date: string) => {
    try {
      ...
      params.append("providerId", doctorId)
      ...
      if (data?.success && data.slots && data.slots.length > 0) {
        ...
        const virtualSlots = [
          { _id: "v1", startTime: "10:00", endTime: "10:30", isAvailable: true },
          { _id: "v2", startTime: "11:00", endTime: "11:30", isAvailable: true },
          { _id: "v3", startTime: "12:00", endTime: "12:30", isAvailable: true },
          { _id: "v4", startTime: "16:00", endTime: "16:30", isAvailable: true },
          { _id: "v5", startTime: "17:00", endTime: "17:30", isAvailable: true },
        ]
        setTimeSlots(virtualSlots)
      }
      setLoadingSlots(false)
    } catch (error) {
